 ...
 * @author qxo
 */
public class BugOracleDeleteIllegalWhere extends TestCase {

    static {
        System.out.println(":" + SQLStatement.class.getProtectionDomain().getCodeSource().getLocation());
        //System.setProperty("druid_sql_parser_end_assert_off", "true");
    }

    public void test4deleteWhere() throws Exception {
        // @formatter:off
        Object[][] samples =  {
            { "delete from test_tab1 swhere  a=1", false},
